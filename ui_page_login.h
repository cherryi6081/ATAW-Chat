...
public:
    ...
    void setupUi(QWidget *Page_login)
    {
        ...
        gridLayout->addWidget(lb_image, 1, 1, 9, 1);
        ...
        gridLayout->addWidget(lb_title, 3, 0, 1, 1);
        ...
        setNetBut = new QPushButton(Page_login);
        ...
        gridLayout->addWidget(setNetBut, 0, 0, 1, 1);
