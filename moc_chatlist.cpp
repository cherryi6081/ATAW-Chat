...
#include <memory>
#include "chat_Client/chatlist.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_chatList_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_chatList_t qt_meta_stringdata_chatList = {
    {
        QT_MOC_LITERAL(0, 8)   // "chatList"
    },
    "chatList"
};
...
Q_CONSTINIT static const uint qt_meta_data_chatList[] = {
...
Q_CONSTINIT const QMetaObject chatList::staticMetaObject = { {
    ...
    qt_meta_stringdata_chatList.offsetsAndSizes,
    qt_meta_data_chatList,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_chatList_t,
        // Q_OBJECT / Q_GADGET
